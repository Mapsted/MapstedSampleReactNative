...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${PODS_ROOT}/mapsted-sdk-loc-marketing/LocationMarketing.framework"
  install_framework "${PODS_ROOT}/mapsted-sdk-location-share/MapstedLocationShare.framework"
  install_framework "${PODS_ROOT}/mapsted-sdk-map/MapstedMap.framework"
  install_framework "${PODS_ROOT}/mapsted-sdk-map-ui/MapstedMapUi.framework"
