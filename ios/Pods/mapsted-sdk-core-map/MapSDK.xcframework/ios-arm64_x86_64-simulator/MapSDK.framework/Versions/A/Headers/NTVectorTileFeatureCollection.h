...
extern "C" {
#endif
@class NTVectorTileFeatureVector;

/**
 * A collection of vector tile features.
 */
__attribute__ ((visibility("default"))) @interface NTVectorTileFeatureCollection : NTFeatureCollection
/** @internal:nodoc: */
-(void*)getCptr;
/** @internal:nodoc: */
 ...
 */
/** @internal:nodoc: */
+(NTVectorTileFeatureCollection*)swigCreatePolymorphicInstance:(void*)cPtr swigOwnCObject:(BOOL)cMemoryOwn;
