 ...
 */
__attribute__ ((visibility("default"))) @interface NTPackageManagerReverseGeocodingService : NTReverseGeocodingService
/** @internal:nodoc: */
-(void*)getCptr;
/** @internal:nodoc: */
 ...
 */
/** @internal:nodoc: */
+(NTPackageManagerReverseGeocodingService*)swigCreatePolymorphicInstance:(void*)cPtr swigOwnCObject:(BOOL)cMemoryOwn;
...
-(NSString*)getLanguageSwigExplicitNTPackageManagerReverseGeocodingService;
-(void)setLanguage: (NSString*)lang;
-(void)setLanguageSwigExplicitNTPackageManagerReverseGeocodingService: (NSString*)lang;
-(NTGeocodingResultVector*)calculateAddresses: (NTReverseGeocodingRequest*)request;
-(NTGeocodingResultVector*)calculateAddressesSwigExplicitNTPackageManagerReverseGeocodingService: (NTReverseGeocodingRequest*)request;
/**
