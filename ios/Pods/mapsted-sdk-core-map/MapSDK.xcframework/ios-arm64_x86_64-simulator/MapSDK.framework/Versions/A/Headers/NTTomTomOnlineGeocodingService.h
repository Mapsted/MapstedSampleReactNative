 ...
 */
__attribute__ ((visibility("default"))) @interface NTTomTomOnlineGeocodingService : NTGeocodingService
/** @internal:nodoc: */
-(void*)getCptr;
/** @internal:nodoc: */
 ...
 */
/** @internal:nodoc: */
+(NTTomTomOnlineGeocodingService*)swigCreatePolymorphicInstance:(void*)cPtr swigOwnCObject:(BOOL)cMemoryOwn;
...
-(BOOL)isAutocomplete;
-(BOOL)isAutocompleteSwigExplicitNTTomTomOnlineGeocodingService;
-(void)setAutocomplete: (BOOL)autocomplete;
-(void)setAutocompleteSwigExplicitNTTomTomOnlineGeocodingService: (BOOL)autocomplete;
-(NSString*)getLanguage;
-(NSString*)getLanguageSwigExplicitNTTomTomOnlineGeocodingService;
-(void)setLanguage: (NSString*)lang;
-(void)setLanguageSwigExplicitNTTomTomOnlineGeocodingService: (NSString*)lang;
-(int)getMaxResults;
-(int)getMaxResultsSwigExplicitNTTomTomOnlineGeocodingService;
-(void)setMaxResults: (int)maxResults;
-(void)setMaxResultsSwigExplicitNTTomTomOnlineGeocodingService: (int)maxResults;
-(NTGeocodingResultVector*)calculateAddresses: (NTGeocodingRequest*)request;
-(NTGeocodingResultVector*)calculateAddressesSwigExplicitNTTomTomOnlineGeocodingService: (NTGeocodingRequest*)request;
/**
