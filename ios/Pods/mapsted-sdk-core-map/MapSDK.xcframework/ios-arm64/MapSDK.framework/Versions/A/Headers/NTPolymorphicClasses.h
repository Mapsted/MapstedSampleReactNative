...
#import "NTVectorTileFeatureBuilder.h"
...
static void initNTPolymorphicClasses() {
  ...
  [NTOrderedTileDataSource class];
  [NTLocalVectorDataSource class];
  [NTAssetTileDataSource class];
  [NTGeoJSONVectorTileDataSource class];
  ...
  [NTHillshadeRasterTileLayer class];
  ...
  [NTBalloonPopupButtonStyle class];
  ...
  [NTPolygon class];
  [NTLabel class];
  [NTBalloonPopupButton class];
  [NTPoint class];
  [NTCustomPopup class];
  [NTGeometryCollection class];
  [NTText class];
  [NTPopup class];
  [NTBalloonPopupEventListener class];
  [NTMarker class];
