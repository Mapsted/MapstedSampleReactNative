 ...
 */
__attribute__ ((visibility("default"))) @interface NTNMLModelStyle : NTBillboardStyle
/** @internal:nodoc: */
-(void*)getCptr;
/** @internal:nodoc: */
 ...
 */
/** @internal:nodoc: */
+(NTNMLModelStyle*)swigCreatePolymorphicInstance:(void*)cPtr swigOwnCObject:(BOOL)cMemoryOwn;
