...
SWIFT_CLASS("_TtC11MapstedCore16BridgeCMSManager")
@interface BridgeCMSManager : NSObject
...
SWIFT_CLASS("_TtC11MapstedCore24BridgeCoreDataController")
@interface BridgeCoreDataController : NSObject
...
SWIFT_CLASS("_TtC11MapstedCore31BridgeMNCoreNotificationManager")
@interface BridgeMNCoreNotificationManager : NSObject
+ (void)postNotificationWithInfoWithType:(enum MNCoreNotificationType)type userInfo:(NSDictionary * _Nullable)userInfo;
...
SWIFT_CLASS("_TtC11MapstedCore24BridgeMapstedCoreSyncApi")
@interface BridgeMapstedCoreSyncApi : NSObject
...
+ (void)onMapstedGeofenceEventWithPropertyId:(NSInteger)propertyId geofenceId:(NSString * _Nonnull)geofenceId;
...
+ (void)onDestinationReachedWithWaypoint:(MapstedWaypoint * _Nonnull)waypoint;
...
+ (void)onRouteInstructionWithNextKeyPoint:(MNRouteNode * _Nonnull)nextKeyPoint afterNextKeyPoint:(MNRouteNode * _Nullable)afterNextKeyPoint;
...
+ (void)reportLocationUpdateWithLocations:(NSArray<CLLocation *> * _Nonnull)locations;
+ (void)reportLocationUpdateWithError:(NSError * _Nonnull)error;
+ (void)onSDKSuccess;
+ (void)onSDKFailureWithErrorCode:(EnumSdkError)errorCode;
+ (void)onSDKStatusUpdateWithUpdate:(EnumSdkUpdate)update;
...
+ (NSString * _Nonnull)productKey SWIFT_WARN_UNUSED_RESULT;
+ (BOOL)validateProductLicOnline SWIFT_WARN_UNUSED_RESULT;
...
+ (void)onPhoneHeadingChangedWithHeadingRad:(CGFloat)headingRad;
+ (void)onPhoneHeadingAccuracyChangedWithAccuracy:(MNConfidence)accuracy;
+ (void)onUserHeadingChangedWithHeadingRad:(CGFloat)headingRad;
+ (void)onFusedUserHeadingChangedWithHeadingRad:(CGFloat)headingRad;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC11MapstedCore11DataPackage")
@interface DataPackage : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (void)initializeWithPropertyId:(NSInteger)propertyId type:(MNPackageType)type filerId:(NSString * _Nonnull)filerId status:(MNPackageStatus)status;
- (void)printLog;
- (NSInteger)getPropertyId SWIFT_WARN_UNUSED_RESULT;
/// buildingId > 0 if single building, buildingId = -1 if multi-building
- (MNPackageType)getPackageType SWIFT_WARN_UNUSED_RESULT;
- (NSString * _Nonnull)getFilerId SWIFT_WARN_UNUSED_RESULT;
- (MNPackageStatus)getStatus SWIFT_WARN_UNUSED_RESULT;
@end


/// : Destination interuction data
SWIFT_CLASS("_TtC11MapstedCore24DestinationInstructionDO")
@interface DestinationInstructionDO : NSManagedObject
- (nonnull instancetype)initWithEntity:(NSEntityDescription * _Nonnull)entity insertIntoManagedObjectContext:(NSManagedObjectContext * _Nullable)context OBJC_DESIGNATED_INITIALIZER;
@end



@interface DestinationInstructionDO (SWIFT_EXTENSION(MapstedCore))
...
SWIFT_CLASS_NAMED("EntityZoneDistance")
@interface MNEntityZoneDistance : NSObject
- (nonnull instancetype)initWithZone:(MNEntityZone * _Nonnull)zone distance:(double)distance OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
SWIFT_PROTOCOL("_TtP11MapstedCore30FusedUserHeadingChangeListener_")
@protocol FusedUserHeadingChangeListener
/// This function will call everytime fused user heading changes
- (void)onFusedUserHeadingChangedWithHeadingRad:(CGFloat)headingRad;
@end
...
typedef SWIFT_ENUM(NSInteger, IsReachable, open) {
  IsReachableWifi = 1,
...
/// Notification types.
typedef SWIFT_ENUM(NSInteger, MNCoreNotificationType, open) {
...
/// Post a notification when get a shareLocation event
  ...
  MNCoreNotificationTypeGlobalCategoriesUpdated = 22,
  MNCoreNotificationTypePropertyUpdated = 23,
  MNCoreNotificationTypeDataCaptureUpdated = 24,
};
...
@property (nonatomic) BOOL AllowOffPremiseBackgroundLocationScanning;
@property (nonatomic) BOOL enableBluetoothAdHocScanning;
...
@property (nonatomic) BOOL enableLocationServices;
@end
...
- (NSString * _Nonnull)getDataCaptureURL SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_CLASS("_TtC11MapstedCore8MapStyle")
@interface MapStyle : NSObject
- (void)initializeWithFilerId:(NSString * _Nonnull)filerId fileName:(NSString * _Nonnull)fileName;
- (NSString * _Nonnull)getFilerId SWIFT_WARN_UNUSED_RESULT;
- (NSString * _Nullable)getFileName SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (void)initializeWithPropertyId:(NSInteger)propertyId buildingId:(NSInteger)buildingId name:(NSString * _Nonnull)name locations:(NSArray<MNMercatorZone *> * _Nonnull)locations entityZones:(NSArray<MNEntityZone *> * _Nonnull)entityZones;
- (NSInteger)getPropertyId SWIFT_WARN_UNUSED_RESULT;
/// buildingId > 0 if single building, buildingId = -1 if multi-building
- (NSInteger)getBuildingId SWIFT_WARN_UNUSED_RESULT;
- (NSString * _Nonnull)getName SWIFT_WARN_UNUSED_RESULT;
- (MapstedWaypoint * _Nullable)clone SWIFT_WARN_UNUSED_RESULT;
- (NSArray<MNEntityZone *> * _Nullable)getEntityZones SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_PROTOCOL("_TtP11MapstedCore34PhoneHeadingAccuracyChangeListener_")
@protocol PhoneHeadingAccuracyChangeListener
/// This function will call everytime phone heading accuracy changes
- (void)onPhoneHeadingAccuracyChangedWithAccuracy:(MNConfidence)accuracy;
@end


SWIFT_PROTOCOL("_TtP11MapstedCore26PhoneHeadingChangeListener_")
@protocol PhoneHeadingChangeListener
/// This function will call everytime phone heading changes
- (void)onPhoneHeadingChangedWithHeadingRad:(CGFloat)headingRad;
@end
...
SWIFT_PROTOCOL("_TtP11MapstedCore26PropertyCompletionListener_")
@protocol PropertyCompletionListener
...
SWIFT_PROTOCOL("_TtP11MapstedCore25UserHeadingChangeListener_")
@protocol UserHeadingChangeListener
/// This function will call everytime user heading changes
- (void)onUserHeadingChangedWithHeadingRad:(CGFloat)headingRad;
@end


SWIFT_PROTOCOL("_TtP11MapstedCore28ValidBlueDotCallbackListener_")
@protocol ValidBlueDotCallbackListener
/// This function will call everytime valid blue dot changes are received
- (void)onValidBlueDotStateChangeWithError:(EnumValidBlueDotError)error;
@end
