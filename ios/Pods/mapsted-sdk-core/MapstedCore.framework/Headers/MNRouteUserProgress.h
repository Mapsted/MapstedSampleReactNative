...
@interface MNRouteUserProgress : NSObject
    ...
    //IOS-339 - Added method getDistanceTimeToEndOfRoute
    @property (readonly, nonnull) MNRouteDistanceTime* distanceTimeToRoute;
    @property (readonly, nonnull) MNRouteDistanceTime* distanceTimeToEndOfRoute;
    ...
    //IOS-339 - Added method getDistanceTimeToEndOfRoute
    - (MNRouteDistanceTime* _Nonnull) getUserDistanceTimeToRoute;
    - (MNRouteDistanceTime* _Nonnull) getDistanceTimeToEndOfRoute;
