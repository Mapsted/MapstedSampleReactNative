...
@class CppGeofenceTriggerBuilder;
...
//- (void)setup:(MNLanguageType)languageType calibrationMode:(BOOL)calibrationMode dataCaptureMode:(BOOL)dataCaptureMode dataCaptureID:(int)dataCaptureID DataCaptureByteArray:(nullable NSData *)byteData;

-(void)setup:(MNLanguageType)languageType operationMode:(EnumSdkMode)operationMode dataCaptureID:(int)dataCaptureID DataCaptureByteArray:(nullable NSData *)byteData mercatorZoneUserPath:(nullable NSArray<MNMercatorZone *> *)MercatorZoneUserPath SimulatorspeedModifier:(float)speedModifier;
...
- (void)onSelectedCurrentLocationByAR:(nonnull MNMercatorZone*)location;
...
/// Function to get an estimated distance time for a route with options 'routeOptions' towards an entity within a building
///
/// - Parameter 'entityZone':  The entity towards which the routing will be requested.
/// - Parameter 'routeOptions': Options for the routing
/// - Parameter 'buildingId': The building containing the entity searched for.
///
/// - Returns: an estimated distance time for a route, nil if invalid

- (nullable MNRouteDistanceTime *)requestDistanceTimeEstimateToEntityZone:(nonnull MNEntityZone *)entityZone routeOptions:(nonnull MNRouteOptions *)routeOptions;

/// Function to get an estimated distance time for a route with options 'routeOptions' towards an a mercator zone
///
/// - Parameter 'mercatorZone':  The zone towards which the routing will be requested.
/// - Parameter 'routeOptions': Options for the routing
/// - Parameter 'buildingId': The building containing the entity searched for.
///
/// - Returns: an estimated distance time for a route, nil if invalid

- (nullable MNRouteDistanceTime *)requestDistanceTimeEstimateToMercatorZone:(nonnull MNMercatorZone *)mercatorZone routeOptions:(nonnull MNRouteOptions *)routeOptions;
...
- (nullable MNRouteDistanceTime *)requestDistanceTimeEstimateBetweenMercatorZones:(nonnull MNMercatorZone *)start destination:(nonnull MNMercatorZone *)destination routeOptions:(nonnull MNRouteOptions *)routeOptions;
...
- (nonnull NSArray *)getSelectNearbyEntityZoneDistances:(int)buildingId;
...
- (void)reportLocations:(NSArray<CLLocation *> *)locations ;
- (void)reportError:(NSError*)error;

/* Geofences */
- (BOOL) addGeofenceTrigger:(int)propertyId geofenceTriggerBuilder: (nonnull CppGeofenceTriggerBuilder *) geofenceTriggerBuilder;
- (BOOL) addGeofenceTriggers:(int)propertyId geofenceTriggerBuilders: (nonnull NSArray<CppGeofenceTriggerBuilder *> *) geofenceTriggerBuilders;
- (BOOL) removeGeofenceTrigger:(int)propertyId geofenceId:(nonnull NSString*)geofenceId;
- (BOOL) removeAllGeofenceTriggers:(int)propertyId;
-(EnumValidBlueDotError)getValidBlueDotErrorType;

-(nullable NSString *)getCartoCSSFilerId:(nonnull NSData *)data;


-(void)enableSnapBlueDotToRoute:(BOOL)enable;
-(BOOL)isSnapBlueDotToRouteEnabled;
