...
typedef NS_ENUM(int, MapstedRouteSegmentType);
...
@property (readonly) MapstedRouteSegmentType segmentType;

/// A list of route nodes
@property (readonly, nonnull) NSArray<MNRouteNode *> *routeNodes;

/// A list of route nodes
@property (readonly, nonnull) NSMutableDictionary* keyPointDistanceTimes;
...
@property (readonly) NSInteger buildingId;
...
- (nonnull id)initWithRouteNodes:(nonnull NSArray<MNRouteNode *> *)routeNodes smoothedRouteNodes:(nonnull NSArray<MNMercator *> *)smoothedRouteNodes segmentType:(MapstedRouteSegmentType)segmentType transitionType:(RouteTransitionType)transitionType propertyId:(int)propertyId buildingId:(int)buildingId floorId:(int)floorId;
