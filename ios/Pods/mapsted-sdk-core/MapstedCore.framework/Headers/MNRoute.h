...
/***************************************************************************/
/// Boolean to check if the route starts from user location
@property (readonly) BOOL isStartAtUserLocation;
...
- (nonnull id)initWithRoute:(nonnull NSArray<MNRouteSegment *> *)segments startNode:(nullable MNRouteNode *)statNode destinationNode:(nullable MNRouteNode *)destinationNode distTimeEstimate:(nullable MNRouteDistanceTime *)distanceTime alertIds: (nonnull NSArray<NSString*> *) alertIds detourDistanceTime:(nullable MNRouteDistanceTime *)detourDistanceTime isStartAtUserLocation: (BOOL)isStartAtUserLocation;
