...
public class DataBinderMapperImpl extends DataBinderMapper {
  ...
  public List<DataBinderMapper> collectDependencies() {
    ...
    result.add(new com.mapsted.map.DataBinderMapperImpl());
    result.add(new com.mapsted.ui.DataBinderMapperImpl());
    return result;
  }
  ...
  private static class InnerBrLookup {
    ...
    static {
      sKeys.put(0, "_all");
      sKeys.put(1, "adapter");
      sKeys.put(2, "buildingInfo");
      sKeys.put(3, "distance");
      sKeys.put(4, "distanceTime");
      sKeys.put(5, "listener");
      sKeys.put(6, "navgraph");
      sKeys.put(7, "selectedRoute");
